...
const HeroSection = () => {
  return (
    <section className="relative bg-therapy-warm/30 py-20 md:py-32">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Link
              ...
              smooth={true}
              duration={500}
              className="bg-therapy-warm/80 text-therapy-blue px-8 py-3 rounded-full hover:bg-therapy-warm/90 transition-colors duration-300 text-center border border-therapy-blue"
            >
              Therapieangebote
            </Link>
            <Link
